    ...
    <div className="w-full max-w-md rounded-3xl border border-stone-200 bg-white p-8 shadow-xl transition-all duration-300">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-stone-500">
          Join HavenDecor to start designing and managing your interior spaces.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-xs font-semibold uppercase tracking-wider text-stone-500 mb-1.5">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
